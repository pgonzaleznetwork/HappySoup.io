...
As said above, Salesforce Happy Soup has :white_check_mark:**fixed all**:white_check_mark: this issues so that you can focus on learning about your dependencies rather than fighting the API!
